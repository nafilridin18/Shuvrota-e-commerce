        ...
        <div class="row g-4 g-lg-5">
            <div class="col-12 col-md-6 position-relative">
                <div class="media-display-container mb-3" id="displayBox"
                    ...
                    <?php if ($stock_out): ?>
                        <div class="stock-out-overlay" style="border-radius: var(--radius-lg);">
            ...
            <div class="col-12 col-md-6">
                ...
                <?php if ($stock_out): ?>
                    <div class="stock-out-panel">
                        ...
                        <div>
                            <span class="stock-out-title">
                                <span class="lang-bn">এই পণ্যটি বর্তমানে স্টকে নেই</span>
                                <span class="lang-en">This product is currently out of stock</span>
                            </span>
                            <span class="stock-out-sub">
                                <span class="lang-bn">শীঘ্রই আবার স্টকে আসবে — উইশলিস্টে যোগ করে রাখতে পারেন।</span>
                                <span class="lang-en">It'll be back soon — add it to your wishlist to save it.</span>
                            </span>
                        </div>
                    </div>
                <?php else: ?>
                    <div class="mb-3">
                        <span class="badge bg-success p-2">
                            <span class="lang-bn">স্টকে আছে: <?= $stock_qty ?> টি</span>
                            <span class="lang-en">In Stock: <?= $stock_qty ?> pcs</span>
                        </span>
                    </div>
                <?php endif; ?>
                ...
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="size" class="form-select rounded-pill" required <?= $stock_out ? 'disabled' : '' ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="color" class="form-select rounded-pill" required <?= $stock_out ? 'disabled' : '' ?>>
                            <?php if (!empty($variants)): ?>
                    ...
                    <div class="mb-3" style="max-width: 150px;">
                        ...
                        <input type="number" name="quantity" value="1" min="1" max="<?= max(1, $stock_qty) ?>" class="form-control rounded-pill text-center" <?= $stock_out ? 'disabled' : '' ?>>
                    </div>

                    <div class="d-flex gap-2 flex-wrap">
                        <?php if ($stock_out): ?>
                            <button type="button" class="btn btn-secondary px-4 py-2 fw-bold rounded-pill shadow-sm" disabled style="opacity:0.7;cursor:not-allowed;">
                            ...
                            <a href="wishlist.php?add=<?= $product['id'] ?>" class="btn btn-outline-danger px-4 py-2 fw-bold rounded-pill shadow-sm">
                                ...
                                <span class="lang-bn">উইশলিস্টে রাখুন</span>
                                <span class="lang-en">Save to Wishlist</span>
                            </a>
                        <?php else: ?>
